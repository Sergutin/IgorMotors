...
urlpatterns = [
    ...
    path(
        'add_to_favorites/<int:car_id>/', views.add_to_favorites,
        name='add_to_favorites'
        ),
    path(
        'remove_from_favorites/<int:car_id>/', views.remove_from_favorites,
    ...
    path(
        'get_car_transmissions/', views.get_car_transmissions,
        name='get_car_transmissions'
        ),
    path('get_car_engines/', views.get_car_engines, name='get_car_engines'),
    path(
        'get_estimated_price/', views.get_estimated_price,
