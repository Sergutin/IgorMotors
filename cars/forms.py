...
from .models import Car, Make, CarMake, CarModel, CarYear
...
class CarSelectionForm(forms.Form):
    car_make = forms.ModelChoiceField(
        ...
        CarMake.objects.filter(name__in=[]),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['car_mileage'].widget.attrs.update(
            {'class': 'form-control'}
            )
        self.fields['car_transmission'].widget.attrs.update(
            {'class': 'form-control'}
            )
        self.fields['car_engine'].widget.attrs.update(
            {'class': 'form-control'}
            )
